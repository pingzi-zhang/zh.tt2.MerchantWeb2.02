$(function () {
    ...
    var strActionName="Product_GetFoodProductPage";
    	...
    	function handle(){
           ...
           for(var i = 0; i < tdStatus.length;i++){
       			...
       			$(look).on("click",function(){
       				...
       				//type == "0801" 是桌餐
       				if(type == "0801"){
       					window.location.href = "viewFoodProduct.html?index="+_index+"";
       				}else{
       					window.location.href = "viewProduct.html?index="+_index+"";
       				}
       			});
           		...
           		if(tdStatus.eq(i).html()=="未提交" || tdStatus.eq(i).html()=="已下架" || tdStatus.eq(i).html()=="未通过"){
           			...
           			$(edit).on("click",function(){
           				var _index = $(this).parent().attr("data");
           				//states为1是修改状态,为0是提交状态
           				var status = 1;
           				var type = $(this).parent().attr("type");
           				//type == "0801" 是桌餐
           				if(type == "0801"){
         					/*window.location.href = "changeFood.html?index="+_index+"&status="+status+"";*/
         					window.location.href = "changeFoodAdd.html?index="+_index+"&status="+status+"";
           				}else{
           					window.location.href = "changeBuffet.html?index="+_index+"&status="+status+"";
           				}
           			});
