$(function () {
    ...
    var strActionName="Product_GetNativeProductPage";
    	...
    	function handle(){
           ...
           for(var i = 0; i < tdStatus.length;i++){
       			...
       			$(look).on("click",function(){
       				...
       				window.location.href = "viewSpecialty.html?index="+_index+"";
       			});
           		...
           		if(tdStatus.eq(i).html()=="未提交" || tdStatus.eq(i).html()=="已下架" || tdStatus.eq(i).html()=="未通过"){
           			...
           			$(edit).on("click",function(){
         				...
         				window.location.href = "changeSpecialty.html?index="+_index+"";
           			});
